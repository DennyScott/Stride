...
public class UserModel {
    ...
    public boolean add(User newUser) throws IOException, ClassNotFoundException, SQLException {
        ...
        String answerString = "(" + "null" + ", " + "\"" + newUser.getUsername() + seperateValue() + newUser.getPassword() + seperateValue() + newUser.getFirstName() + seperateValue() + newUser.getLastName() + seperateValue() + newUser.getEmailAddress() + seperateValue() + newUser.getNumberOfQuestions() + seperateValue() + newUser.getNumberOfAnswers() + seperateValue() + newUser.getVotes() + seperateValue() + subDate + seperateValue() + subDate + seperateValue() + newUser.getProfilePictureLink() + seperateValue() + newUser.getBiography() + seperateValue() + newUser.getRank() + seperateValue() + (newUser.isAnonymous() ? 1 : 0) + seperateValue() + newUser.getGoldCount() + seperateValue() + newUser.getSilverCount() + seperateValue() + newUser.getBronzeCount() + seperateValue() + newUser.getReputation() + "\")";
